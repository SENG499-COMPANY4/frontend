  ...
  return (
    ...
    <div class="container mx-auto px-10 max-w-screen-lg">
      ...
      <div class="flex flex-col bg-white border shadow-sm rounded-xl p-4 my-10 md:p-5 dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7] dark:text-gray-400">
        ...
        <textarea class="py-3 px-4 my-4 block w-full border border-gray-200 rounded-md text-sm focus:outline-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" rows="3" placeholder="This is a textarea placeholder"></textarea>
      </div>
